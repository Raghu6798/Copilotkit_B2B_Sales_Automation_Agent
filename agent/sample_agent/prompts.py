...
# Task
Evaluate the provided lead and company report and assign a single numeric score from 0 to 10, representing the overall quality and potential of the lead.

# Scoring Criteria
(Use the detailed criteria below to determine the score, but DO NOT include any explanation or breakdown in your response.)

- Digital Presence (Website & Blog)
- Social Media Activity
- Industry Fit
- Company Scale and Potential
- Existing Marketing Strategy
- Pain Points & Opportunities

# Output Instructions
**IMPORTANT:**
- Output ONLY the final numeric score (e.g., 7.2).
- Do NOT include any explanation, commentary, markdown, or additional text.
- Your response must be a single number between 0 and 10, with up to one decimal place if needed.
- Do NOT include the word "Score", "points", or any other words—just the number.
- Do NOT include any formatting, bullet points, or extra lines.
- If you include anything other than the number, your response will be rejected.
